...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationAppLovin/AppLovinAdapter-10.3.3.0/AppLovinAdapter.xcframework" "AppLovinAdapter" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
